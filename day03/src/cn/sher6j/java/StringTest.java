...
public class StringTest {
    ...
    2.String实现了Serializable接口，即字符串是支持序列化的
            实现了Comparable接口，即字符串可以比较大小
    ...
    public void test3() {
        ...
        String s8 = s5.intern();//返回得到的s8使用的常量值中已经存在的数据
